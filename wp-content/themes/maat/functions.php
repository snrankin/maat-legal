...
if ( ! function_exists( 'maat_setup' ) ) :
	...
	function maat_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'maat' ),
		) );
...
function maat_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'maat' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'maat' ),
 ...
 */
function maat_scripts() {
	wp_enqueue_style( 'maat-style', get_stylesheet_uri() );

	wp_enqueue_script( 'maat-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'maat-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );

	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
		wp_enqueue_script( 'comment-reply' );
	}
}
add_action( 'wp_enqueue_scripts', 'maat_scripts' );
